...
// Full ISO 3166-1 list — home country can be ANY country (not just study
// destinations). The 19 destination codes below are also referenced by the
// university/scholarship seeding, so their codes must stay stable.
const COUNTRY_ROWS: [string, string, string][] = [
  // ---- Africa ----
  ['Algeria', 'DZ', 'Africa'], ['Angola', 'AO', 'Africa'], ['Benin', 'BJ', 'Africa'],
  ['Botswana', 'BW', 'Africa'], ['Burkina Faso', 'BF', 'Africa'], ['Burundi', 'BI', 'Africa'],
  ['Cameroon', 'CM', 'Africa'], ['Cape Verde', 'CV', 'Africa'], ['Central African Republic', 'CF', 'Africa'],
  ['Chad', 'TD', 'Africa'], ['Comoros', 'KM', 'Africa'], ['Congo', 'CG', 'Africa'],
  ['DR Congo', 'CD', 'Africa'], ['Djibouti', 'DJ', 'Africa'], ['Egypt', 'EG', 'Africa'],
  ['Equatorial Guinea', 'GQ', 'Africa'], ['Eritrea', 'ER', 'Africa'], ['Eswatini', 'SZ', 'Africa'],
  ['Ethiopia', 'ET', 'Africa'], ['Gabon', 'GA', 'Africa'], ['Gambia', 'GM', 'Africa'],
  ['Ghana', 'GH', 'Africa'], ['Guinea', 'GN', 'Africa'], ['Guinea-Bissau', 'GW', 'Africa'],
  ['Ivory Coast', 'CI', 'Africa'], ['Kenya', 'KE', 'Africa'], ['Lesotho', 'LS', 'Africa'],
  ...
  ['Rwanda', 'RW', 'Africa'], ['Senegal', 'SN', 'Africa'], ['Seychelles', 'SC', 'Africa'],
  ['Sierra Leone', 'SL', 'Africa'], ['Somalia', 'SO', 'Africa'], ['South Africa', 'ZA', 'Africa'],
  ['South Sudan', 'SS', 'Africa'], ['Sudan', 'SD', 'Africa'], ['Tanzania', 'TZ', 'Africa'],
  ['Togo', 'TG', 'Africa'], ['Tunisia', 'TN', 'Africa'], ['Uganda', 'UG', 'Africa'],
  ['Zambia', 'ZM', 'Africa'], ['Zimbabwe', 'ZW', 'Africa'],
  // ---- Asia ----
  ...
  ['Cyprus', 'CY', 'Asia'], ['Georgia', 'GE', 'Asia'], ['India', 'IN', 'Asia'],
  ['Indonesia', 'ID', 'Asia'], ['Iran', 'IR', 'Asia'], ['Iraq', 'IQ', 'Asia'],
  ['Israel', 'IL', 'Asia'], ['Japan', 'JP', 'Asia'], ['Jordan', 'JO', 'Asia'],
  ['Kazakhstan', 'KZ', 'Asia'], ['Kuwait', 'KW', 'Asia'], ['Kyrgyzstan', 'KG', 'Asia'],
  ['Laos', 'LA', 'Asia'], ['Lebanon', 'LB', 'Asia'], ['Malaysia', 'MY', 'Asia'],
  ['Maldives', 'MV', 'Asia'], ['Mongolia', 'MN', 'Asia'], ['Myanmar', 'MM', 'Asia'],
  ['Nepal', 'NP', 'Asia'], ['North Korea', 'KP', 'Asia'], ['Oman', 'OM', 'Asia'],
  ['Pakistan', 'PK', 'Asia'], ['Palestine', 'PS', 'Asia'], ['Philippines', 'PH', 'Asia'],
  ['Qatar', 'QA', 'Asia'], ['Saudi Arabia', 'SA', 'Asia'], ['Singapore', 'SG', 'Asia'],
  ['South Korea', 'KR', 'Asia'], ['Sri Lanka', 'LK', 'Asia'], ['Syria', 'SY', 'Asia'],
  ['Taiwan', 'TW', 'Asia'], ['Tajikistan', 'TJ', 'Asia'], ['Thailand', 'TH', 'Asia'],
  ['Timor-Leste', 'TL', 'Asia'], ['Turkey', 'TR', 'Asia'], ['Turkmenistan', 'TM', 'Asia'],
  ['United Arab Emirates', 'AE', 'Asia'], ['Uzbekistan', 'UZ', 'Asia'], ['Vietnam', 'VN', 'Asia'],
  ['Yemen', 'YE', 'Asia'],
  // ---- Europe ----
  ...
  ['Bulgaria', 'BG', 'Europe'], ['Croatia', 'HR', 'Europe'], ['Czechia', 'CZ', 'Europe'],
  ['Denmark', 'DK', 'Europe'], ['Estonia', 'EE', 'Europe'], ['Finland', 'FI', 'Europe'],
  ['France', 'FR', 'Europe'], ['Germany', 'DE', 'Europe'], ['Greece', 'GR', 'Europe'],
  ['Hungary', 'HU', 'Europe'], ['Iceland', 'IS', 'Europe'], ['Ireland', 'IE', 'Europe'],
  ['Italy', 'IT', 'Europe'], ['Kosovo', 'XK', 'Europe'], ['Latvia', 'LV', 'Europe'],
  ['Liechtenstein', 'LI', 'Europe'], ['Lithuania', 'LT', 'Europe'], ['Luxembourg', 'LU', 'Europe'],
  ['Malta', 'MT', 'Europe'], ['Moldova', 'MD', 'Europe'], ['Monaco', 'MC', 'Europe'],
  ['Montenegro', 'ME', 'Europe'], ['Netherlands', 'NL', 'Europe'], ['North Macedonia', 'MK', 'Europe'],
  ['Norway', 'NO', 'Europe'], ['Poland', 'PL', 'Europe'], ['Portugal', 'PT', 'Europe'],
  ['Romania', 'RO', 'Europe'], ['Russia', 'RU', 'Europe'], ['San Marino', 'SM', 'Europe'],
  ['Serbia', 'RS', 'Europe'], ['Slovakia', 'SK', 'Europe'], ['Slovenia', 'SI', 'Europe'],
  ['Spain', 'ES', 'Europe'], ['Sweden', 'SE', 'Europe'], ['Switzerland', 'CH', 'Europe'],
  ['Ukraine', 'UA', 'Europe'], ['United Kingdom', 'GB', 'Europe'], ['Vatican City', 'VA', 'Europe'],
  // ---- North America ----
  ['Antigua and Barbuda', 'AG', 'North America'], ['Bahamas', 'BS', 'North America'],
  ['Barbados', 'BB', 'North America'], ['Belize', 'BZ', 'North America'], ['Canada', 'CA', 'North America'],
  ['Costa Rica', 'CR', 'North America'], ['Cuba', 'CU', 'North America'], ['Dominica', 'DM', 'North America'],
  ['Dominican Republic', 'DO', 'North America'], ['El Salvador', 'SV', 'North America'],
  ['Grenada', 'GD', 'North America'], ['Guatemala', 'GT', 'North America'], ['Haiti', 'HT', 'North America'],
  ['Honduras', 'HN', 'North America'], ['Jamaica', 'JM', 'North America'], ['Mexico', 'MX', 'North America'],
  ['Nicaragua', 'NI', 'North America'], ['Panama', 'PA', 'North America'],
...
const COUNTRIES: { name: string; code: string; region: string }[] = COUNTRY_ROWS.map(
  ([name, code, region]) => ({ name, code, region }),
);
